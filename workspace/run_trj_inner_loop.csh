...
set curr_dir=`pwd`
set work_dir=${base_dir}/inloop_trj
set ptd_repo_dir=${base_dir}/opt_pert
...
ln -sf ${namelist_repo_dir}/namelist.input.trj_inner namelist.input
ln -sf ${util_repo_dir}/plus.io_config plus.io_config
cp ${ptd_repo_dir}/wrfinput_d01_perturbed wrfinput_d01
